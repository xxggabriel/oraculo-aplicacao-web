...
<body class="bg-slate-950 text-slate-50 antialiased">
    <div class="min-h-screen flex flex-col">
        <header class="sticky top-0 z-40 border-b border-white/10 bg-slate-950/80 backdrop-blur">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
                <div class="flex items-center gap-3">
                    <div
                        class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-300 to-amber-600 text-lg font-black text-slate-950 shadow-lg">
                        Ω
                    </div>
                    <div>
                ...
                <nav class="flex items-center gap-2">
                    <a href="{{ route('jurisprudencia.index') }}"
                        class="rounded-lg border border-white/10 bg-white/10 px-3 py-2 text-sm font-medium text-slate-50 shadow-sm transition hover:border-amber-300 hover:bg-amber-300/20">
                        Busca
                    </a>
                    <a href="/admin"
                        class="rounded-lg border border-white/10 px-3 py-2 text-sm font-medium text-slate-200 transition hover:border-amber-300 hover:bg-amber-300/10">
                        Admin
                    </a>
                    <a href="#"
                        class="rounded-lg border border-white/10 px-3 py-2 text-sm font-medium text-slate-200 transition hover:border-amber-300 hover:bg-amber-300/10">
        ...
        <main id="jurisprudencia-app" data-search-url="{{ route('jurisprudencia.search') }}"
            data-show-base="{{ url('/jurisprudencia/processos') }}" class="flex-1">
            <div class="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 sm:px-6">
                <div class="grid gap-6 lg:grid-cols-[330px,1fr]">
                    <aside
                        class="space-y-4 rounded-2xl border border-white/5 bg-slate-900/70 p-4 shadow-lg shadow-amber-500/5">
                        ...
                        <form id="filters-form" class="space-y-4">
                            <div
                                ...
                                <label class="relative inline-flex cursor-pointer items-center">
                                    ...
                                    <div
                                        class="peer h-6 w-10 rounded-full border border-white/10 bg-slate-700 transition peer-checked:border-amber-300 peer-checked:bg-amber-400/80">
                                    </div>
                                    <div
                                        class="absolute left-1 top-1 h-4 w-4 rounded-full bg-white transition peer-checked:translate-x-4">
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="tribunais" name="tribunais[]" multiple size="4"
                                    class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring">
                            ...
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-slate-200" for="classes">Classes
                                    processuais</label>
                                <select id="classes" name="classes[]" multiple size="4"
                                    class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring">
                                    <option disabled>Carregando...</option>
                                </select>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="assuntos" name="assuntos[]" multiple size="4"
                                    class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring">
                                    <option disabled>Carregando...</option>
                                </select>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="graus" name="graus[]" multiple size="2"
                                    class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="space-y-2">
                                    <label class="text-sm font-medium text-slate-200" for="confianca_min">Confiança
                                        mín.</label>
                                    <input id="confianca_min" name="confianca_min" type="number" step="0.01"
                                        min="0" max="1"
                                        class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring" />
                                </div>
                                <div class="space-y-2">
                                    <label class="text-sm font-medium text-slate-200" for="confianca_max">Confiança
                                        máx.</label>
                                    <input id="confianca_max" name="confianca_max" type="number" step="0.01"
                                        min="0" max="1"
                                        class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="space-y-2">
                                    <label class="text-sm font-medium text-slate-200"
                                        for="data_distribuicao_inicio">Dist. inicial</label>
                                    <input id="data_distribuicao_inicio" name="data_distribuicao_inicio"
                                        type="date"
                                        class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring" />
                                </div>
                                <div class="space-y-2">
                                    <label class="text-sm font-medium text-slate-200"
                                        for="data_distribuicao_fim">Dist. final</label>
                                    <input id="data_distribuicao_fim" name="data_distribuicao_fim" type="date"
                                        class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="space-y-2">
                                    <label class="text-sm font-medium text-slate-200"
                                        for="data_julgamento_inicio">Julg. inicial</label>
                                    <input id="data_julgamento_inicio" name="data_julgamento_inicio" type="date"
                                        class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring" />
                                </div>
                                <div class="space-y-2">
                                    <label class="text-sm font-medium text-slate-200" for="data_julgamento_fim">Julg.
                                        final</label>
                                    <input id="data_julgamento_fim" name="data_julgamento_fim" type="date"
                                        class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring" />
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-slate-200"
                                    for="classificacoes">Classificação</label>
                                <select id="classificacoes" name="classificacoes[]" multiple size="4"
                                    class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring">
                                    <option disabled>Carregando...</option>
                                </select>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="modelos" name="modelos[]" multiple size="3"
                                    class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring">
                                    <option disabled>Carregando...</option>
                                </select>
                            </div>
                            ...
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-slate-200" for="versoes">Versão do
                                    modelo</label>
                                <select id="versoes" name="versoes[]" multiple size="3"
                                    class="w-full rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 outline-none ring-amber-400/40 focus:border-amber-300 focus:ring">
                                    <option disabled>Carregando...</option>
                                </select>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-2 pt-2">
                                ...
                                <button type="button" id="refresh-results"
                    ...
                    <section class="space-y-4">
                        <div
                            class="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/5 bg-slate-900/70 p-4 shadow-lg shadow-amber-500/5">
                            <div>
                        ...
                        <div id="stats-cards" class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                            <div
                                class="rounded-xl border border-dashed border-white/10 bg-slate-900/40 p-4 text-sm text-slate-400">
                                Carregando estatísticas...
                            </div>
                        </div>

                        <div
                            class="overflow-hidden rounded-2xl border border-white/5 bg-slate-900/70 shadow-lg shadow-amber-500/5">
                        ...
                        <div id="pagination"
                            class="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/5 bg-slate-900/70 px-4 py-3 text-sm text-slate-300">
    ...
    <div id="loading-overlay"
        ...
        <div
            class="flex flex-col items-center gap-3 rounded-2xl border border-white/10 bg-slate-900/80 px-6 py-4 text-sm text-slate-100 shadow-xl shadow-amber-500/10">
